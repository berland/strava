...
:::{#second-col}
:::{.r-stack}
![](gfx/tiljobb.png){.fragment .fade-in-then-out fragment-index=1 width=200}
![](gfx/pushover.png){.fragment .fade-in-then-out fragment-index=2 width=200}
![](gfx/tirsdag.png){.fragment .fade-in-then-out fragment-index=3 width=200}
